 ...
 * @author user
 */
public class TableCell1 implements TableCellRenderer {
    ...
    try{
        ...
        for(int u=0;u<counter;){
            ...
            color1[u]=rand.nextInt(256-60)+60;
            color2[u]=rand.nextInt(256-70)+70;
            color3[u]=rand.nextInt(256-60)+60;
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        Object result=table.getModel().getValueAt(row,column);
            for(int t=0;t<counter;t++){
                ...
                else if(result.toString().contains("L3")){
                   
                    c.setBackground(Color.PINK);
                }
                else if(result.toString().contains("L4")){
                   // Color col1=new Color(68,162,255);
                    c.setBackground(Color.GRAY);
                }
                else if(result.toString().contains("L2")){
                    Color col1=new Color(68,162,255);
                    c.setBackground(col1);
                }
                else if(result.toString().contains("L1")){
